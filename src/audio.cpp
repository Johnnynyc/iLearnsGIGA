...
String tempLetter = "";
String currentAudio = "";
String base = "/usb/Split-wav/";
String Sounds[] = {

  //pLetta to pLettz - Point Letter
  "pLetta", "pLettb", "pLettc", "pLettd", "pLette", "pLettf", 
  "pLettg", "pLetth", "pLetti", "pLettj", "pLettk", "pLettl", 
  "pLettm", "pLettn", "pLetto", "pLettp", "pLettq", "pLettr", 
  "pLetts", "pLettt", "pLettu", "pLettv", "pLettw", "pLettx", 
  "pLetty", "pLettz",

  //sLetta to sLettz - Sound Letter
  "sLetta", "sLettb", "sLettc", "sLettd", "sLette", "sLettf", 
  "sLettg", "sLetth", "sLetti", "sLettj", "sLettk", "sLettl", 
  "sLettm", "sLettn", "sLetto", "sLettp", "sLettq", "sLettr", 
  "sLetts", "sLettt", "sLettu", "sLettv", "sLettw", "sLettx", 
  "sLetty", "sLettz",

  //pNuma to pNumt - Point Number
  "pNuma", "pNumb", "pNumc", "pNumd", "pNume", "pNumf", 
  "pNumg", "pNumh", "pNumi", "pNumj", "pNumk", "pNuml", 
  "pNumm", "pNumn", "pNumo", "pNump", "pNumq", "pNumr", 
  "pNums", "pNumt",
